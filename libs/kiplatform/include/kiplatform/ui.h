...
namespace KIPLATFORM
{
    namespace UI
    {
         ...
         *
         * @return true if  aResult was set and the caller should return it from MSWWindowProc().
         */
        ...
        /**
         * Execute JavaScript in a wxWebView without requesting a result when the
         * platform backend supports it.
         *
         * On macOS this avoids WKWebView's async result deserialization path, which
         * can enter JavaScriptCore while KiCad is running a nested modal event loop
         * from a tool coroutine stack.
         *
         * @param aWebView the wxWebView instance
         * @param aScript JavaScript source to execute
         * @return true if platform-specific fire-and-forget execution was used
         */
        ...
        /**
         * Force creation of WebKit's shared JSContext (and its JavaScriptCore VM) now,
         * on the current (real) main-thread stack.
         *
         * Performs work once per process (retries on failure).  No-op on non-macOS
         * platforms (returns true).
         *
         * @param aWebView the wxWebView instance
         * @return true once the shared JSContext is warm (or warming is not needed)
         */
        bool WarmWebViewJSContext( wxWindow* aWebView );

        /**
         * Keep WebKit's shared JSContext (and its JavaScriptCore VM) alive after it
         * has been warmed.  No-op on non-macOS platforms.
         *
         * @param aWebView the wxWebView instance
         */
