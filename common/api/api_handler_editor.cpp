        ...
        const HANDLER_CONTEXT<DeleteItems>& aCtx )
{
    ...
    {
        // Attach each result to the response — a locally-constructed result
        // that is never added leaves clients unable to tell IDS_OK from
        // IDS_NONEXISTENT (deletes silently skip items not on this screen).
