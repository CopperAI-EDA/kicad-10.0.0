...
#ifdef KICAD_IPC_API
    // Create the API server for native plugins and the AI Agent webview IPC bridge.
    // The MCP HTTP server is now a standalone process and is not embedded in KiCad.
