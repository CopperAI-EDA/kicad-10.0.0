...
void BuildBitmapInfo( std::unordered_map<BITMAPS, std::vector<BITMAP_INFO>>& aBitmapInfoCache )
{
    ...
    aBitmapInfoCache[BITMAPS::copper_ai_agent].emplace_back( BITMAPS::copper_ai_agent, wxT( "copper_ai_agent_24.png" ), 24, wxT( "light" ) );
    aBitmapInfoCache[BITMAPS::copper_ai_agent].emplace_back( BITMAPS::copper_ai_agent, wxT( "copper_ai_agent_dark_24.png" ), 24, wxT( "dark" ) );
    aBitmapInfoCache[BITMAPS::copper_ai_agent].emplace_back( BITMAPS::copper_ai_agent, wxT( "copper_ai_agent_48.png" ), 48, wxT( "light" ) );
    aBitmapInfoCache[BITMAPS::copper_ai_agent].emplace_back( BITMAPS::copper_ai_agent, wxT( "copper_ai_agent_dark_48.png" ), 48, wxT( "dark" ) );
