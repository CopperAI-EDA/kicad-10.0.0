...
// Copper AI is a modified software distribution derived from KiCad. KiCad is open-source software licensed primarily under GPLv3-or-later. Copper AI is not affiliated with or endorsed by the KiCad project or the Linux Foundation.
static const wxChar* COPPER_AI_KICAD_LEGAL_NOTICE =
        wxT( "Copper AI is a modified software distribution derived from KiCad. "
             "KiCad is open-source software licensed primarily under GPLv3-or-later. "
             "Copper AI is not affiliated with or endorsed by the KiCad project or the Linux Foundation." );
...
static void buildKicadAboutBanner( EDA_BASE_FRAME* aParent, ABOUT_APP_INFO& aInfo )
{
    ...
    description << wxT( "<p>" )
                << _( "Copper AI is an electronics design software distribution with built-in AI support." )
                << wxT( "</p>" );

    description << wxT( "<p>" )
                << COPPER_AI_KICAD_LEGAL_NOTICE
                << wxT( "</p>" );
    ...
    description << wxT( "<p><b><u>" )
                << _( "Copper AI and upstream resources" )
                << wxT( "</u></b>" ); // bold & underlined font for caption

    // bullet-ed list with some http links
    description << wxT( "<ul>" );
    description << wxT( "<li>" )
                << _( "Upstream KiCad website - " )
                << HtmlHyperlink( wxS( "http://www.kicad.org" ) )
                << wxT( "</li>" );
    description << wxT( "<li>" )
                << _( "Upstream developer website - " )
                << HtmlHyperlink( wxS( "https://go.kicad.org/dev" ) )
                << wxT( "</li>" );

    description << wxT( "<li>" )
                << _("Upstream KiCad library repositories - " )
    ...
    description << wxT( "<p><b><u>" )
                << _( "Upstream KiCad community" )
                << wxT( "</u></b>" ); // bold & underlined font caption

    description << wxT( "<ul>" );
    description << wxT( "<li>" )
                << _( "Upstream KiCad forum - " )
